...
public class AddressBook {
     ...
     * to be used by HashMap<PersonProperty, String>.
     * For example, a person's name is stored in Name in HashMap<PersonProperty.NAME, Name>.
     * Likewise, a person's phone is stored in Phone in HashMap<PersonProperty.PHONE, Phone>.
     * And, a person's email is stored in Email in HashMap<PersonProperty.EMAIL, Email>.
     */
    ...
    /*
     * NOTE : =============================================================================================
     * Note that the type of the variable below can also be declared as ArrayList<HashMap<PersonProperty, String>>, as follows:
