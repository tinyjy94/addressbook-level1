...
public class AddressBook {
    ...
    private static final String COMMAND_ADD_EXAMPLE = COMMAND_ADD_WORD + " John Doe p/98765432 e/johnd@gmail.com b/12-03-1994";
    ...
    */
    ...
    private static String extractPhoneFromPersonString(String encoded) {
        ...
        if (indexOfPhonePrefix > indexOfEmailPrefix) {
            return removePrefix(encoded.substring(indexOfPhonePrefix, indexOfBirthdayPrefix).trim(),
    ...
    private static String extractEmailFromPersonString(String encoded) {
        final int indexOfPhonePrefix = encoded.indexOf(PERSON_DATA_PREFIX_PHONE);
        final int indexOfEmailPrefix = encoded.indexOf(PERSON_DATA_PREFIX_EMAIL);
        final int indexOfAgePrefix = encoded.indexOf(PERSON_DATA_PREFIX_BIRTHDAY);
    ...
    private static String extractBirthdayFromPersonString(String encoded) {
        ...
        return removePrefix(encoded.substring(indexOfBirthdayPrefix, encoded.length()).trim(),
    ...
    private static boolean isPersonBirthdayValid(String birthday) {
        return birthday.matches("(((0[1-9]|[12]\\d|3[01])[-](0[13578]|1[02])[-]((1[6-9]|"
